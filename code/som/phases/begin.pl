...
diffused_to_relative(_, DiffusableWellbeing, Relative, DiffusedWellbeing) :-
    ...
    message_sent(Relative, wellbeing_transfer([fullness=DiffusedWellbeing.fullness, integrity=DiffusedWellbeing.integrity, engagment=DiffusedWellbeing.engagement])),
    !.
