...
* An established experience (persisting over multiple timeframes) is felt more strongly than a possibly transient experience.
...
* A CA feels only the more strongly felt dimension at any time.
