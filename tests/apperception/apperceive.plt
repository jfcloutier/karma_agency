...
test(find_causal_theories) :-
    ...
    log(info, tests, 'Sequence is ~p', [Sequence]),
    MaxSignatureExtension = max_extension{max_object_types:2, max_objects:2, max_predicate_types:2},
    ApperceptionLimits = apperception_limits{max_signature_extension: MaxSignatureExtension, max_theories_per_template: 1000, good_enough_coverage: 85, keep_n_theories: 3, funnel: 3-2, time_secs: 30},
